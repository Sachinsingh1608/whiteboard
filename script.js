const canvas = document.querySelector("canvas"),
  ...
  shapeSelect = document.querySelector("#shape-select"), // New: Getting the shape selection dropdown
...
const drawArrow = (e) => {
  ...
  // Stroke or fill based on the checkbox
...
// Event listener for shape selection dropdown
shapeSelect.addEventListener("change", () => {
  selectedTool = shapeSelect.value; // Update selectedTool based on the selected option
});
